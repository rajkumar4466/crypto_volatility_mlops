...
- [x] **Phase 7: CI/CD Pipeline** - GitHub Actions lint/test on PR, Docker build to ECR and Lambda deploy on merge (completed 2026-03-13)
...
| 7. CI/CD Pipeline | 1/1 | Complete   | 2026-03-13 |
